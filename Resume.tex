...
{\bodytext \noindent \emph{As a self-motivated individual pursuing simple quality over quantity in a fast-paced world where shipping buggy code is secondary to reducing tech debt, I enjoy working and communicating with a team who share my values. }}
% \\
% \\
% Biography
% \end{multicols}
